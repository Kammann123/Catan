...
public:
	...
	*/
	...
	static UIComponent* createInfoBox(string id, size_t size, double width, double height);
	static UIComponent* createToggleInfoBox(string id, size_t size, double width, double height);
